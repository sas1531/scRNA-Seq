...
#markers_3_7
markers_neuron <- markers_0_2_4_5 #Plus 6
...
write.table(markers_neuron, file = "markers_neuron.tsv", sep = "\t", quote = FALSE)
...
# Intersect cluster dataframes with cell classifier minimal dataframe 
cell_class_cluster_min <- inner_join(all_cluster, cell_class_min, by = "gene")
cell_class_cluster_min

View(cell_class_cluster_min)
...
write.table(cell_class_cluster_min, file = "cell_class_cluster_minimal.tsv", sep = "\t", quote = FALSE)
...
# Filter minimal dataframe for significance 
...
COMPARE ALL CLUSTERS THEN COMBINE
