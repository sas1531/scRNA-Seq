...
lat_scale <- RunPCA(object = ly20_scale, features = VariableFeatures(object = ly20_scale))
...
VizDimLoadings(object = un_scale, dims = 1:2, reduction = "pca")
VizDimLoadings(object = lat_scale, dims = 1:2, reduction = "pca")
VizDimLoadings(object = lat_scale, dims = 1:2, reduction = "pca")
VizDimLoadings(object = ly48_scale, dims = 1:2, reduction = "pca")
...
lat_pca
ly20_pca <- DimPlot(object = lat_scale, reduction = "pca", cols = c("darkgoldenrod2", "darkgoldenrod2"))
ly20_pca
...
un_scale <- RunTSNE(object = un_scale, dims = 1:20, tsne.method = "Rtsne")
un_tsne <- DimPlot(object = un_scale, reduction = "tsne")
un_tsne

lat_scale <- RunTSNE(object = lat_scale, dims = 1:20, tsne.method = "Rtsne")
lat_tsne <- DimPlot(object = lat_scale, reduction = "tsne")
lat_tsne

ly20_scale <- RunTSNE(object = ly20_scale, dims = 1:20, tsne.method = "Rtsne")
ly20_tsne <- DimPlot(object = ly20_scale, reduction = "tsne")
ly20_tsne

ly48_scale <- RunTSNE(object = ly48_scale, dims = 1:20, tsne.method = "Rtsne")
